#https://github.com/marshmellow77/sm-hf-processor/blob/main/scripts/preprocessing-hf.py
import transformers
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(input_data_path, compression='gzip', sep='\t')
    
    # map star rating to binary
    df.loc[:, ('label')] = df['star_rating'].apply(lambda x: 1 if x >= args.star_threshold else 0)
